...
@section('title', 'Create Shipping Policy - ' . $siteName . ' Admin')
                ...
                <div class="col-md-6">
                    <div class="p-3 bg-light border rounded-4 h-100">
                        ...
                        <div>
                            ...
                            <input type="number" step="{{ old('criteria_type', 'cart_price') === 'cart_count' ? '1' : '0.01' }}" name="from_value" id="fromValueInput" class="form-control form-control-sm rounded-3" value="{{ old('from_value', 0) }}" min="{{ old('criteria_type', 'cart_price') === 'cart_count' ? '1' : '0' }}" inputmode="{{ old('criteria_type', 'cart_price') === 'cart_count' ? 'numeric' : 'decimal' }}" required>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="p-3 bg-light border rounded-4 h-100">
                        ...
                        <div>
                            ...
                            <input type="number" step="{{ old('criteria_type', 'cart_price') === 'cart_count' ? '1' : '0.01' }}" name="to_value" id="toValueInput" class="form-control form-control-sm rounded-3" value="{{ old('to_value') }}" min="{{ old('criteria_type', 'cart_price') === 'cart_count' ? '1' : '0' }}" inputmode="{{ old('criteria_type', 'cart_price') === 'cart_count' ? 'numeric' : 'decimal' }}" placeholder="Unlimited if left empty">
                        </div>
                    </div>
                </div>
            </div>
