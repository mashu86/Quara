...
<div class="row g-3 g-md-4">
    <!-- Left Main Column (Operation & Products) -->
    <div class="col-lg-7">
    ...
    <!-- Right Column (Financial Refunds & Associated Order Info) -->
    <div class="col-lg-5">
        <!-- Financial Impact Breakdown & Immutable Refund History -->
        <div class="card border-0 rounded-4 shadow-sm mb-3 mb-md-4">
            <div class="card-header bg-white py-2.5 py-sm-3 border-bottom">
                <h6 class="fw-bold mb-0 text-dark"><i class="fa-solid fa-calculator text-warning me-2"></i> Financial Refund Records</h6>
            </div>
            <div class="card-body p-3 p-sm-4">
                <div class="row g-2.5 g-sm-3 mb-3">
                    <div class="col-6">
                        <div class="p-2.5 p-sm-3 border rounded-3 bg-light text-center">
                            <span class="text-muted small d-block mb-1" style="font-size: 0.72rem;">Return Date</span>
                            <div class="fw-bold text-dark style-small" style="font-size: 0.82rem;">
                    ...
                    <div class="col-6">
                        <div class="p-2.5 p-sm-3 border rounded-3 bg-light text-center">
                            <span class="text-muted small d-block mb-1" style="font-size: 0.72rem;">Total Money Refunded</span>
                ...
                <!-- Refund History List -->
                <h6 class="fw-bold text-dark mb-2" style="font-size: 0.8rem;">Immutable Refund History Log</h6>
                @if($operation->refunds->count() > 0)
                    <div class="table-responsive mb-3">
                        <table class="table table-sm table-bordered align-middle mb-0" style="font-size: 0.74rem;">
                ...
                @else
                    <div class="alert alert-light border text-muted small py-2 px-3 mb-3" style="font-size: 0.75rem;">
                        <i class="fa-solid fa-info-circle me-1"></i> No monetary refund recorded for this operation.
                    </div>
                @endif
                ...
                <div class="p-3 bg-warning-subtle rounded-3 border border-warning d-flex justify-content-between align-items-center">
                    ...
                    <span class="fs-5 fw-bold text-danger">-₹{{ number_format($operation->total_refund_amount, 2) }}</span>
                </div>
            </div>
        </div>
