...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        <h3 class="fw-bold mb-1">Edit Shipping Policy</h3>
        <p class="text-muted small mb-0">Modifying policy: <strong>{{ $shippingPolicy->name }}</strong></p>
    </div>
...
<form action="{{ route('admin.shipping-policies.update', $shippingPolicy->id) }}" method="POST">
    ...
    <div class="card border-0 rounded-4 shadow-sm max-w-800 mx-auto overflow-hidden">
        <div class="card-header bg-dark text-white p-4">
            <h5 class="fw-bold mb-0 text-warning"><i class="fa-solid fa-pen-to-square me-2"></i> Edit Policy Configuration</h5>
        </div>
        <div class="card-body p-4 p-sm-5">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="name" class="form-control rounded-3 py-2" value="{{ old('name', $shippingPolicy->name) }}" required>
            </div>
            ...
            <button type="submit" class="btn btn-warning rounded-pill fw-bold w-100 py-3 shadow-sm text-dark fs-6 mt-2">
                <i class="fa-solid fa-circle-check me-2"></i> UPDATE SHIPPING POLICY
            </button>
        </div>
    </div>
</form>
