...
<div class="d-lg-none mb-3">
    <div class="d-flex gap-2">
        <button type="button" class="btn btn-dark rounded-pill px-3 py-2 flex-grow-1 shadow-sm d-flex align-items-center justify-content-center gap-2 search-trigger-btn" data-bs-toggle="modal" data-bs-target="#manualSalesFilterModal">
            ...
            <span class="fw-semibold">Filter Offline Sales</span>
...
<div class="card border-0 rounded-4 shadow-sm mb-4 d-none d-lg-block">
    <div class="card-body p-3">
        <form action="{{ route('admin.manual-sales.index') }}" method="GET" class="row g-2 align-items-end">
            ...
            <div class="col-lg-2 col-md-2 d-flex gap-1.5 align-self-end mt-2 mt-md-0">
                <button type="submit" class="btn btn-dark rounded-pill w-100" title="Filter Sales"><i class="fa-solid fa-filter me-1"></i> Filter</button>
                @if($activeManualFilterCount > 0)
                    <a href="{{ route('admin.manual-sales.index') }}" class="btn btn-outline-secondary rounded-pill" title="Reset Filters"><i class="fa-solid fa-rotate-left"></i></a>
                @endif
            </div>
        </form>
    </div>
        ...
        <div class="modal-content border-0 shadow-lg rounded-4">
            <div class="modal-header bg-dark text-white rounded-top-4 py-3">
                <h5 class="modal-title font-serif fw-bold" id="manualSalesFilterModalLabel">
                    <i class="fa-solid fa-sliders text-warning me-2"></i> Filter Offline Sales
                </h5>
