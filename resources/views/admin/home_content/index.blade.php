...
@section('title', 'Home Main Content Master - ' . $siteName . ' Admin')
                        ...
                        <tr>
                            ...
                            <td class="text-end pe-3">
                                <div class="d-flex align-items-center justify-content-end gap-1.5 flex-nowrap">
                                    <a href="{{ route('admin.home-content.edit', $hc->id) }}" class="btn btn-sm btn-outline-dark rounded-circle p-0 d-inline-flex align-items-center justify-content-center shadow-sm" style="width: 32px; height: 32px;" title="Edit Entry">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <form action="{{ route('admin.home-content.destroy', $hc->id) }}" method="POST" class="d-inline mb-0" onsubmit="return confirm('Delete this home content entry?')">
                                        @csrf
                                        @method('DELETE')
