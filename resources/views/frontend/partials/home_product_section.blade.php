    ...
    <div class="container">
        ...
        <div class="d-lg-none mb-4">
            <div class="d-flex gap-2">
                <button type="button" class="btn btn-dark rounded-pill px-3 py-2 flex-grow-1 shadow-sm d-flex align-items-center justify-content-center gap-2" data-bs-toggle="modal" data-bs-target="#homeFilterModal">
                ...
                @if($activeFilterCount > 0)
                    <a href="{{ route('home') }}" class="btn btn-outline-secondary rounded-pill px-3" title="Clear Filters">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-3 d-none d-lg-block">
                <div class="bg-light p-4 rounded-4 shadow-sm border sticky-top" style="top: 100px;">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <h5 class="font-serif fw-bold mb-0"><i class="fa-solid fa-filter text-gold me-2"></i> Filters</h5>
                        @if(count(request()->all()) > 0)
                            <a href="{{ route('home') }}" class="btn btn-link btn-sm text-danger text-decoration-none p-0">Clear All</a>
                        @endif
                    </div>
            ...
            <div class="modal fade d-lg-none" id="homeFilterModal" tabindex="-1" aria-labelledby="homeFilterModalLabel" aria-hidden="true">
